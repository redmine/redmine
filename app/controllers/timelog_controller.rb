...
class TimelogController < ApplicationController
  ...
  def index
    ...
    sort_init(@query.sort_criteria.empty? ? [%w(spent_on desc)] : @query.sort_criteria)
  ...
  def destroy
    destroyed = TimeEntry.transaction do
      @time_entries.each do |t|
        raise ActiveRecord::Rollback unless t.destroy && t.destroyed?
      end
    end
