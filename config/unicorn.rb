...
app_path = "/opt/webs/production/pirati-redmine"

working_directory (rails_env == 'production' ? app_path : `pwd`.gsub("\n", ""))
...
before_fork do |server, worker|
  ...
  old_pid = Rails.env.production? ? "#{app_path}/pids/unicorn.pid.oldbin" :
