...
Rails.application.routes.draw do
  ...
  match 'welcome/welcome_carousel', :to => 'welcome#welcome_carousel', via: [:get, :post]
  ...
  # OSB Explorer webs
  match 'projects/cells_graph', :to => 'projects#cells_graph', :via => [:get, :post]
  match 'projects/cells_list', :to => 'projects#cells_list', :via => [:get, :post]
  match 'projects/cells_gallery', :to => 'projects#cells_gallery', :via => [:get, :post]
  match 'projects/cells_tags', :to => 'projects#cells_tags', :via => [:get, :post]
  match 'projects/technology', :to => 'projects#technology', :via => [:get, :post]
  match 'projects/groups', :to => 'projects#groups', :via => [:get, :post]
  match 'projects/people', :to => 'projects#people', :via => [:get, :post]
  match 'projects/informationOSB', :to => redirect('/docs'), :via => [:get, :post]
  
  match 'projects/:id/generateGEPPETTOSimulationFile', :to => 'projects#generateGEPPETTOSimulationFile', :via => [:get, :post]
  
  # Redirects to new doc pages (To be removed once the new docs is stable)
  match 'guides', :to => redirect('/docs'), :via => [:get, :post]
  match '/projects/gettingstarted(/*path)', :to => redirect('/docs#Getting_Started'), :via => [:get, :post]
  match '/projects/gitintro(/*path)', :to => redirect('/docs/Help/Some_Extra_Information#Introduction_to_Source_Control'), :via => [:get, :post]
  match '/projects/feedback(/*path)', :to => redirect('/docs#How_To_Contact_Us'), :via => [:get, :post]
  match '/projects/neuroinformatics(/*path)', :to => redirect('/docs#Interaction_With_Other_Neuroinformatics_Resources'), :via => [:get, :post]
  match '/projects/simulators(/*path)', :to => redirect('/docs#Simulators'), :via => [:get, :post]
  match '/projects/testprojecu(/*path)', :to => redirect('/docs#Creating_Your_Own_Project'), :via => [:get, :post]
  match '/projects/neuroconstructprojects(/*path)', :to => redirect('/docs#Using_neuroConstruct_Based_Projects'), :via => [:get, :post]
  
  match '/projects/osb/wiki/Meetings(/*path)', :to => redirect('/docs#Meetings'), :via => [:get, :post]
  match '/projects/osb/wiki/Faq(/*path)', :to => redirect('/docs#FAQ'), :via => [:get, :post]
  
  
  
  match 'themes', :to => redirect('/docs/Research_Themes'), :via => [:get, :post]
  match 'embedded/osb(/*path)', :to => redirect('/projects#cells_graph'), :via => [:get, :post]
  
  match 'projects/:id/addTag', :to => 'projects#addTag', :via => [:get, :post]
  match 'projects/:id/removeTag', :to => 'projects#removeTag', :via => [:get, :post]
  
  #match 'searchOSB/tag', :to => 'searchOSB#tag'
  match 'search_custom_field', :to => 'search_custom_field#index', :via => [:get, :post]
